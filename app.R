        ...
        div(
          ...
          tags$ol(
            ...
            tags$li("Alerts: a scan across every region and disease for combinations that trigger the CUSUM/C2 ",
                    ...
                    "separately, in grey, below the main alerts."),
            tags$li("Data visualisation: choose a disease, region, and week, and toggle between reported and ",
                    "projected case counts. The map highlights the selected region, and the chart at the bottom ",
                    "shows how much each region is contributing to the national total for the year."),
            tags$li("Weekly summary table: the full week-by-week table, with conditional shading, for a chosen ",
                    "location.")
          )
        ),
        fluidRow(
